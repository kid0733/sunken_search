...
MAP_FILE= '/Users/siddhant/Code/Python/RealWorldPython/SunkenShip.py/cape_python.png'
...
class Search():
    ...
    def sailor_final_location(self, num_search_areas):
        ...
        """Return the actual x, y location of the missing person"""
        print("SA1 shape:", self.sa1.shape)
        print("SA2 shape:", self.sa2.shape)
        print("SA3 shape:", self.sa3.shape)
